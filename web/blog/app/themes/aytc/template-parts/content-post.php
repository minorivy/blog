	...
	<div class="keni-section">
		...
		<div class="article-body" itemprop="articleBody">
			...
			<div class="article-visual" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
				<img src="<?php echo $url_thumbnail; ?>" alt="<?php echo $image_alt; ?>" />
	...
	<figure class="profile-box-thumb">
		...
		<div class="sns-follow-btn">
           ...
           $user_meta_fb = get_user_meta( $author_id, 'keni_facebook', true );
			  ...
			  $user_meta_github = get_user_meta( $author_id, 'mnr_github', true );
            if ( ! empty( $author_meta_url ) ) : ?>
			<div class="sns-follow-btn_ws"><a href="<?php echo $author_meta_url; ?>" target="_blank"><i class="fas fa-home" aria-hidden="true"></i></a></div>
			<?php endif; ?>
			<?php if ( ! empty( $user_meta_tw ) ) : ?>
			<div class="sns-follow-btn_tw"><a href="<?php echo $user_meta_tw; ?>" target="_blank"><i class="fab fa-twitter" aria-hidden="true"></i></a></div>
			<?php endif; ?>
			<?php if ( ! empty( $user_meta_fb ) ) : ?>
			<div class="sns-follow-btn_fb"><a href="<?php echo $user_meta_fb; ?>" target="_blank"><i class="fab fa-facebook" aria-hidden="true"></i></a></div>
			<?php endif; ?>
			<?php if ( ! empty( $user_meta_ins ) ) : ?>
			<div class="sns-follow-btn_insta"><a href="<?php echo $user_meta_ins; ?>" target="_blank"><i class="fab fa-instagram" aria-hidden="true"></i></a></div>
			<?php endif; ?>
			<?php if ( ! empty( $user_meta_github ) ) : ?>
			<div class="sns-follow-btn_github"><a href="<?php echo $user_meta_github; ?>" target="_blank"><i class="fab fa-github"></i></a></div>
			<?php endif;?>
		</div>
	</figure>
